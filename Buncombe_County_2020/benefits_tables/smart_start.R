...
# Buncombe County market rates for $839 for infant and $747 for 3-5
...
market_rates <- c(`0` = 0,
                  `1` = 839,
                  `2` = 839 + 929, # 839 + 929 (infant plus 3 to 5)
                  `3` = 839 + 929 # for three child families, only two are under 5
)
