...
#
# run cliff_population.R script before running these scripts
#
######################################################

#HH size of 1
cliff_pop_size1 <- income %>% 
  filter(size == 1) %>%
