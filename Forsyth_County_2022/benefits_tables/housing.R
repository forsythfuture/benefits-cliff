...
tenant_rent <- function(kids, income) {
  ...
  # to calculate tenant rent, you subtract a utility allowance from ttp
  # $174 is the average 2021 Forsyth County utility allowance, so we will use it
  # https://www.huduser.gov/portal/datasets/assthsg.html#null
  # go to Data, then select the most recent census
